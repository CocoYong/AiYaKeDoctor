...
@property (nonatomic,strong)  NSMutableDictionary *subtitleBackGroundColors;
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _subtitleFont     = [UIFont systemFontOfSize:20];
        ...
        _titleColors[@(FSCalendarCellStateNormal)]      = [UIColor hexColor:@"#87cfe8"];
        ...
        _titleColors[@(FSCalendarCellStateWeekend)]       = [UIColor lightGrayColor];
//        _titleColors[@(FSCalendarCellStateSpecial)]      =[UIColor hexColor:@"#87cfe8"];
        
        
        _subtitleColors = [NSMutableDictionary dictionaryWithCapacity:4];
        _subtitleColors[@(FSCalendarCellStateNormal)]      = [UIColor whiteColor];
        ...
        _subtitleBackGroundColors = [NSMutableDictionary dictionaryWithCapacity:4];
        _subtitleBackGroundColors[@(FSCalendarCellStateNormal)]      = [UIColor yellowColor];
        _subtitleBackGroundColors[@(FSCalendarCellStateSelected)]    = [UIColor whiteColor];
        _subtitleBackGroundColors[@(FSCalendarCellStateDisabled)]    = [UIColor lightGrayColor];
        _subtitleBackGroundColors[@(FSCalendarCellStatePlaceholder)] = [UIColor lightGrayColor];
        _subtitleBackGroundColors[@(FSCalendarCellStateToday)]       = [UIColor whiteColor];
