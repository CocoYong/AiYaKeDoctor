...
//        titleLabel.backgroundColor=[UIColor blueColor];
        ...
        eventLayer.strokeColor = [UIColor cyanColor].CGColor;
        eventLayer.path = [UIBezierPath bezierPathWithRect:eventLayer.bounds].CGPath;
...
- (void)setBounds:(CGRect)bounds
{
    ...
    CGFloat titleHeight = self.bounds.size.height*2.0/3.0;
    ...
    _eventLayer.path = [UIBezierPath bezierPathWithRect:_eventLayer.bounds].CGPath;
}
...
//        CGFloat height = titleHeight + subtitleHeight;
        _titleLabel.frame = CGRectMake(0,
                                       0,
                                       self.fs_width,
                                       floor(self.contentView.fs_height/2));
        
        _subtitleLabel.frame = CGRectMake(0,
                                          _titleLabel.fs_bottom,
                                          self.fs_width,
                                          floor(self.contentView.fs_height/2));
        _subtitleLabel.backgroundColor=[UIColor yellowColor];
        _subtitleLabel.text=_subtitle;
    } else {
        _titleLabel.frame = CGRectMake(0, 0, self.fs_width, floor(self.contentView.fs_height/2));
    ...
    _eventLayer.strokeColor = _appearance.eventColor.CGColor;
...
//    if ([_specialColorArray containsObject:[NSNumber numberWithInteger:_indexPath.row]])
//    {
//        return dictionary [@(FSCalendarCellStateSpecial)];
//    }
