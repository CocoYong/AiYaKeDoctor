...
+ (void)showSuccessWithStatus:(NSString *)string {
    [SVProgressHUD showSuccessWithStatus:string duration:TOASTTIME];
}
...
+ (void)showErrorWithStatus:(NSString *)string {
    [SVProgressHUD showErrorWithStatus:string duration:TOASTTIME];
}
...
- (UILabel *)stringLabel {
    if (stringLabel == nil) {
		...
		stringLabel.font = [UIFont systemFontOfSize:15];
