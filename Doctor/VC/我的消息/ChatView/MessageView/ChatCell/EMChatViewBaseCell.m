...
- (void)setMessageModel:(MessageModel *)messageModel
{
    ...
    placeholderImage =[UIImage imageNamed:@"doctorDefault"];
    }else
    {
      placeholderImage =[UIImage imageNamed:@"doctorDefault"];
    }
    [self.headImageView sd_setImageWithURL:[_messageModel.message.ext objectForKey:@"fromPhoto"] placeholderImage:placeholderImage];
}
