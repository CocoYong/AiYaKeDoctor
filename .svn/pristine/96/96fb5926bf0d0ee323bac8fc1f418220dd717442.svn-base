...
//    [button1 setBackgroundImage:[UIImage imageNamed:@"0_64"] forState:UIControlStateNormal];
//    button1.frame = CGRectMake(0, 0, 86, 86);
...
//    UIButton *button4 = [UIButton buttonWithType:UIButtonTypeCustom];
    ...
    UIImage* myImageObj = [UIImage imageNamed:@"0_64"];
...
- (void)addRedeemImageAtCenter
{
    ...
    UIImage *image = _draggableImage ?: [UIImage imageNamed:@"0_201"];
