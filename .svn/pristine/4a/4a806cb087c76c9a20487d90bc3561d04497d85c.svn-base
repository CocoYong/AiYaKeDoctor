...
{
    if (_dataSource&&[_dataSource respondsToSelector:@selector(havePatientdateForCalender)]) {
        _eventArray=[_dataSource havePatientdateForCalender];
    }
    return _eventArray;
}
@end
